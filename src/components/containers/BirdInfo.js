	...
	render(){
		...
		if(selectedBird){
			...
			return(
				...
				<span  className="image avatar"><img style={{height: 200,width: 200}} src={picture} alt="" /></span>
				<h2>{spiece}</h2>
				...
				<div style={{position: 'absolute', top: '10%', right: '20%'}} className="shape"><img src={shape} alt=""/></div>
				</header>
				)
		}else{
			 return	<p>Loading..</p>
